...
export default function ProjectPage() {
  ...
  const allProjects = [
    ...
    {
      title: "PCRC WEBSITE - Photography Platform",
      desc: "A dynamic photography portfolio website built with HTML5, CSS3, and JavaScript, featuring a clean user interface, responsive design, and seamless integration with Google Sheets API for real-time content updates.",
      tags: ["JavaScript", "HTML5", "CSS3", "Google Sheets API"],
      category: "Marketplace Project",
      image: "/projects/pcr.webp",
      github: "https://github.com/SaddadSium/PCRC_Web_Version_Demo",
      live: "https://saddadsium.github.io/PCRC_Web_Version_Demo/",
    },
    // {
    ...
    },
    {
      ...
      desc: "A sleek and intuitive to-do list application built with HTML5, CSS3, and JavaScript, featuring a clean user interface, responsive design, and local storage integration for persistent task management.",
      tags: ["JavaScript", "HTML5", "CSS3"],
      category: "University Project",
      image: "/projects/td.webp",
      github: "https://github.com/SaddadSium/Modern-To-Do-List",
      live: "https://saddadsium.github.io/Modern-To-Do-List/",
    },
    {
