      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 relative z-10 space-y-12 text-left">
        ...
        <div className="space-y-4 border-b border-slate-brand/10 pb-8">
          ...
          <p className="text-lightning/40 text-xs font-mono uppercase tracking-widest">
            Last Updated: {lastUpdated} // Version 1.0.4
          </p>
        </div>
        ...
        <div className="space-y-10 leading-relaxed text-lightning/70">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 text-white font-bold text-lg">
              <Lock size={20} className="text-teal-brand" /> 03 // How I Use
              Your Data
            </div>
            <p className="text-sm sm:text-base">
            ...
            <ul className="list-disc pl-5 space-y-2 text-sm sm:text-base">
              ...
              <li>
                Syncing project inquiries with my secure Google Sheets database
                via protected API endpoints.
              </li>
            </ul>
          </section>
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 text-white font-bold text-lg">
              <Globe size={20} className="text-teal-brand" /> 04 // Data
            ...
            <p className="text-sm sm:text-base">
              ...
              with Google Workspace. However, please remember that no method of
          ...
          <section className="space-y-4 border-t border-slate-brand/10 pt-8">
            <div className="flex items-center gap-2 text-white font-bold text-lg">
              <Terminal size={20} className="text-teal-brand" /> 05 // Contact
              for Inquiries
            </div>
            <p className="text-sm sm:text-base">
        ...
        <div className="pt-12 text-center">
          <p className="text-[10px] font-mono text-lightning/30 uppercase tracking-[0.2em]">
            End of Transmission // Secure Environment
          </p>
        </div>
      </div>
    </div>
